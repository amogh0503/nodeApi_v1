...
module.exports=(customer)=>{
  ...
  <body yahoo bgcolor="#ffffff">
            ...
            <tr>
              <td class="innerpadding borderbottom">
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    <td class="bodycopy">
                      A query has been received by customer. Respond to the same as soon as  possible.<br>
                  ...
                  <tr>
                    <td>
                      <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          <td class="bodycopy">
                            <strong>To see the more details of the query. Kindly visit to cp-Panel</strong>
                          </td>
                        </tr>
                        <tr>
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td align="center" class="footercopy">
                     <br><br>&reg; Connect To Grow, All Rights Reserved 2019<br/>
                    </td>
                  </tr>
                  <tr>
    ...
    var mailOptions = {
        from: 'teamcodenova@gmail.com',
        to: 'connectogrow@gmail.com, swapnil_tiwari@outlook.com',//, karankhera1996@gmail.com, swapnil_tiwari@outlook.com, rishabh.goyal0001@gmail.com, nikhileshofficial@gmail.com, endlay.nazuk@gmail.com', 
